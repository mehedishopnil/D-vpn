    ...
    return (
        <div className="py-10">
            ...
            <div className="flex justify-center gap-5 pt-[75px]">
                <div>
                    <p className="text-[11px] font-light text-white mb-10">END OF Q4 2021</p>
                <div className="w-[412px] rounded-xl border border-[#ffffff30]  bg-black px-5 py-10">
                    ...
                    <p className="text-[13px] text-white mt-5">Lorem ipsum dolor sit amet consectetur. Tincidunt ac eu est semper quisque dictum sem interdum ut. Euismod vel lacus at magna fringilla</p>
                </div>
                </div>
