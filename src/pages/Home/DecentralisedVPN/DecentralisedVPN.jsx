    ...
    <div className="relative mt-24 lg:mt-0 ">
      <div className="container mx-auto px-4 lg:px-8 py-10 space-y-5">
        <div className="flex flex-col items-center gap-5">
          <h1 className="text-4xl z-10 md:w-[60%] lg:w-1/2 leading-snug lg:text-5xl lg:leading-snug text-center text-white mb-8">
          ...
          <div className="grid z-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-5 lg:gap-5">
            ...
            {/* Second layout */}
            <div className="grid z-10 md:grid-cols-2 lg:grid-cols-3 bg-[#ffffff25] rounded-xl p-5 border border-[#ffffff30]">
              <div className="text-center lg:flex lg:flex-col lg:text-start lg:justify-center md:col-span-1 lg:col-span-2">
                <h1 className="text-xl  lg:text-2xl text-white mb-2">
                  Lorem ipsum dolor
                </h1>
