  ...
  return (
    <div
      ...
      <div className="w-full lg:w-full pb-16 flex flex-col items-center justify-center mt-10 lg:-mt-36 z-20">
        <div className=" md:flex md:justify-center  lg:flex lg:justify-center space-y-5 md:space-y-0 md:gap-8 lg:gap-10 rounded-lg lg:mb-40  border border-[#ffffff35] bg-[#1a1a1a] py-5 px-10 overflow-hidden">
