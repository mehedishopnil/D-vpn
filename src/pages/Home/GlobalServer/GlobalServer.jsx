...
const GlobalServer = () => {
  return (
    <div className="relative lg:mt-[200px] overflow-hidden h-screen" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover' }}>
      {/* Main content */}
      ...
      <div className="relative flex flex-col items-center justify-center gap-5 mt-10 lg:mt-20">
        <div className="w-full lg:w-1/2 relative">
          <img className="w-3/4 lg:w-[544px] lg:h-[924px] mx-auto" src={iphoneIcon} alt="iPhone Icon" />
