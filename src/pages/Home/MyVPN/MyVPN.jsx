...
const MyVPN = () => {
  ...
  <p className="w-[333px] text-white text-base font-light">
    ...
    tincidunt egestas. Lacinia ac tortor.
      ...
      <div className="absolute -top-16 left-0 bottom-0 w-[645px] h-[745px] rounded-r-full overflow-hidden">
        <div
      ...
      <div className="absolute top-[50%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full overflow-hidden">
        <div
